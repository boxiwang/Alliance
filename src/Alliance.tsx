  ...
  return <section className="alliance-page"><CosmicBackdrop />{nav}<main className="alliance-command">
    ...
    {view === "home" && <>
      ...
      <div className="alliance-system-grid">
        <button onClick={() => setView("rallies")}><span>⚔</span><small>WAR ARRAY</small><b>RALLY BEACON</b><p>Boss, player and alliance formations in flight.</p><em>2 LIVE</em></button>
    ...
    {view === "rallies" && <AlliancePanel title="RALLY BEACON" kicker="FORMATIONS IN FLIGHT" onBack={() => setView("home")}><div className="alliance-rally-list"><article><span className="boss">BOSS</span><div><b>VOID LEVIATHAN · L12</b><p>NyxValidator leads · 4/8 fleets</p></div><time>18:42</time><button>JOIN</button></article><article><span className="pvp">PVP</span><div><b>[MOG] WHALESIGNAL</b><p>R4 authorization · 2/6 fleets</p></div><time>04:17</time><button>JOIN</button></article></div></AlliancePanel>}
